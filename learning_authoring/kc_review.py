...
const stateHelp={covered:'At least one KC uses this slide as evidence.',context:'The model classified this slide as non-teaching context, so no KC was expected.',review:'One or more extracted blocks are not linked to a KC. Inspect whether meaningful coverage is missing.',uncovered:'The model explicitly declared content on this slide uncovered.'};
