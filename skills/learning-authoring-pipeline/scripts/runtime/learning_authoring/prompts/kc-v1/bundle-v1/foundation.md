# Shared KC foundation

A Leaf KC is the smallest source-supported capability that can be taught, assessed, and
remediated on its own. A KC Group is only a navigation container.
...
limits, and conflicts remain explicit. Resolve instructional visual relationships independently for each source:
